...
public class CommandJmp extends ICommand {
	 ...
	 * Name of the command
	 */
	private static final String COMMAND_NAME		=			"JMP";

	/**
	 * Create new {@link CommandJmp} command
	 * 
	 * @param vm The {@link VM} to add this command
	 */
	public CommandJmp(VM vm) {
	...
	public void execute(String params) throws VMException {
		...
		if (params.toUpperCase().equals(Registers.REG_IP)) {
			vm.setRegisterValue(Registers.REG_IP, address - 1);
		} else {
