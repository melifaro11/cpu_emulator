 ...
 * DIV a, b
 * 
 * Divides the first operand 'a' (destination operand) by the second operand 'b'
 * (source operand) and stores the result in the destination operand 'a'
 */
public class CommandDiv extends ICommand {
	
	/**
	 * Name of the command
	 */
	private static final String COMMAND_NAME		=			"DIV";

	/**
	 * Create new {@link CommandDiv} command
	 * 
	 * @param vm The {@link VM} to add this command
	 */
	public CommandDiv(VM vm) {
